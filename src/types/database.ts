export interface Database {
  public: {
    Tables: {
      ...
      products: {
        Row: Product
        Insert: Omit<Product, 'id' | 'created_at' | 'chefsculinar_id' | 'chefsculinar_unit' | 'chefsculinar_unit_qty' | 'tingstad_id' | 'tingstad_unit' | 'tingstad_unit_qty'> & { chefsculinar_id?: string | null; chefsculinar_unit?: string | null; chefsculinar_unit_qty?: number | null; tingstad_id?: string | null; tingstad_unit?: string | null; tingstad_unit_qty?: number | null }
